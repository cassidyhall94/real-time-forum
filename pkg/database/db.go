...
func insertPlaceholdersInDB() {
	queries := map[string]string{
		...
		//sender: bar, same convoID as fake chat 2
		"fake chat 1": fmt.Sprintf(`INSERT INTO chats values ("0675de06-2d2c-444f-9d0a-ffd3303068d8", "d5327a90-e76a-46ef-8b09-531875a534c8", "975496ca-9bfc-4d71-8736-da4b6383a575", "DATE", "Hey! How are you?")`),

		//sender: foo, same convoID as fake chat 1
		"fake chat 2": fmt.Sprintf(`INSERT INTO chats values ("0675de06-2d2c-444f-9d0a-ffd3303068d8", "7df13d1c-e9f8-4364-95f8-5dd03e94d862", "6d01e668-2642-4e55-af73-46f057b731f9", "DATE", "Good! And you?")`),
	}
